...
(defun make-environment (width height y-axis)
  (let* ((env (make-env))
         (vert-streamer (make-buffer-streamer 10000 'sketch-vertex))
    ...
    (setf (env-view-matrix env) view-matrix
